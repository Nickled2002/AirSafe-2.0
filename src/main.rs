...
fn main(){
    ...
    let vertex_data = common::create_vertices(&math_func::peaks, colormap_name, 0.0  , 3600.0, 0.0, 7200.0,
                                              30, 30, 2.0, 0.8);//set scale to two and aspect ratio to .7 to .9 for more precise
