...
fn main(){
    ...
    let vertex_data = common::create_vertices(&math_func::peaks, colormap_name, 0.0  , 10800.0, 0.0, 10800.0,
                                              60, 60, 2.0, 0.9);//set scale to two and aspect ratio to .7 to .9 for more precise
